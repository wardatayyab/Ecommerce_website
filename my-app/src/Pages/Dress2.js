...
export default function Jewelry() {
    ...
    const fetchProduct = async () => {
        let response = await axios.get('http://localhost:3200/category/Mencollection');
    ...
    return (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            >
                ...
                <div className="container" style={{ paddingTop: '700px' }}>
...
@media (max-width: 768px) {
    .custom-div {
        ...
        margin-top : -100px;
        background-position: top;  /* Maintain the top position for mobile */
    }
}
